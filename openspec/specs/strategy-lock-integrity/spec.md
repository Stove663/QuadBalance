# strategy-lock-integrity

## Purpose

Distinguish validation soft-pass from lock eligibility, define material review blockers, and require consistent risk presentation and assumption disclosure in strategy lock outputs.
